...
![latest tag](https://img.shields.io/github/v/tag/STMicroelectronics/stm32f7308-dk.svg?color=brightgreen)
...
This **stm32f7308-dk** MCU component repository is one element of the **STM32CubeF7** MCU embedded software package, providing the **STM32F7308-DK** BSP BOARD component part.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32f7308-dk/blob/main/Release_Notes.html).
